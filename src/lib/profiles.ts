...
const PROFILE_DEFINITIONS: DeviceProfile[] = [
  ...
  },
  {
    ...
    channel: "modern",
    title: "iOS Modern",
    description: "适配 sing-box 1.12.x / 1.13.x / 1.14.0-alpha 的 iOS 远端配置模板。",
    recommendedVersions: ["1.12.x", "1.13.x", "1.14.0-alpha"],
  ...
  },
  {
    ...
    description: "适配 sing-box 1.12.x / 1.13.x / 1.14.0-alpha 的 Android 模板。",
    recommendedVersions: ["1.12.x", "1.13.x", "1.14.0-alpha"],
  ...
  },
  {
    ...
    channel: "modern",
    title: "PC Modern",
    description: "适配 sing-box 1.12.x / 1.13.x / 1.14.0-alpha 的桌面端模板。",
    recommendedVersions: ["1.12.x", "1.13.x", "1.14.0-alpha"],
  ...
  },
  {
    ...
    description: "适配 sing-box 1.12.x / 1.13.x / 1.14.0-alpha 的 OpenWrt 模板。",
    recommendedVersions: ["1.12.x", "1.13.x", "1.14.0-alpha"],
