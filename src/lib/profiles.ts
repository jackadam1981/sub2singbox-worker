...
const PROFILE_DEFINITIONS: DeviceProfile[] = [
  {
    ...
    channel: "legacy",
    title: "iOS Legacy",
    description: "适配 sing-box 1.10 / 1.11 的 iOS 远端配置模板。",
    recommendedVersions: ["1.10.x", "1.11.x"],
  ...
  },
  {
    ...
    channel: "modern",
    title: "iOS Modern",
    description: "适配 sing-box 1.12+ 的 iOS 远端配置模板。",
    recommendedVersions: ["1.12.x", "1.13.x"],
    notes: ["使用 1.12+ 的 DNS server 新格式。", "为域名节点补充 domain_resolver。"],
  },
  {
    id: "android-legacy",
    device: "android",
    ...
    description: "适配 sing-box 1.10 / 1.11 的 Android 模板。",
    recommendedVersions: ["1.10.x", "1.11.x"],
  ...
  },
  {
    ...
    description: "适配 sing-box 1.12+ 的 Android 模板。",
    recommendedVersions: ["1.12.x", "1.13.x"],
    notes: ["使用 tun + modern DNS。", "适合作为通用移动端默认模板。"],
  },
  {
    id: "pc-legacy",
    device: "pc",
    channel: "legacy",
    title: "PC Legacy",
    description: "适配 sing-box 1.10 / 1.11 的桌面端模板。",
    recommendedVersions: ["1.10.x", "1.11.x"],
  ...
  },
  {
    ...
    channel: "modern",
    title: "PC Modern",
    description: "适配 sing-box 1.12+ 的桌面端模板。",
    recommendedVersions: ["1.12.x", "1.13.x"],
    notes: ["附带 mixed 入站。", "为 hostname server 自动设置 domain_resolver。"],
  },
  {
    id: "openwrt-legacy",
    device: "openwrt",
    ...
    description: "适配 sing-box 1.10 / 1.11 的 OpenWrt 模板。",
    recommendedVersions: ["1.10.x", "1.11.x"],
  ...
  },
  {
    ...
    description: "适配 sing-box 1.12+ 的 OpenWrt 模板。",
    recommendedVersions: ["1.12.x", "1.13.x"],
    notes: ["面向路由器场景保留显式 interface_name。", "使用 modern DNS 结构。"],
  },
];
